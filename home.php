...
<section class="about-us">
    <div class="block__content block__content_about-us">
        ...
        <!--                <p class="about-us__text"> <span>Квадрошина</span> - это сеть шиномонтажных мастерских, которая охватывает Санкт-Петербург, Пушкин и Колпино. Мы оказываем услуги с 2001 года и нам очень нравится, когда наши клиенты довольны. Поэтому в мастерских трудятся опытные, профессиональные мастера. Они правильно, аккуратно установят шины, сделают точную балансировку на современном оборудовании. Шины, установленные нашими мастерами, проходят долго.</p>-->
        <!--                <p class="about-us__text">За эти годы мы узнали о шинах все, что можно. Поэтому мы создали магазины при наших сервисах, где вам помогут выбрать новые шины, когда они вам понадобятся. Если вдруг шипованная резина потеряла часть шипов - мы устраним и этот недостаток. А если случилась беда с любимыми дисками - мы сделаем реставрацию.</p>-->
        <!--                <p class="about-us__text">Кроме того мы предлагаем усуги по сезонному хранению шин. Ведь балконы не так уж хорошо подходят для этого</p>-->
        <!--            </div>-->
<!--                    <div class="about-us__img about-us__img_1">-->
<!--                        <img src="-->
<!--                            --><?php //echo get_template_directory_uri() ?><!--/assets/img/about-us-img-1.png" alt="car">-->
